...
class DataProcessorStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ProcessDataBatch = channel.stream_unary(
                '/DataProcessor/ProcessDataBatch',
                request_serializer=data__pb2.DataPoint.SerializeToString,
...
def add_DataProcessorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessDataBatch': grpc.stream_unary_rpc_method_handler(
                    servicer.ProcessDataBatch,
                    request_deserializer=data__pb2.DataPoint.FromString,
...
class DataProcessor(object):
    ...
    @staticmethod
    def ProcessDataBatch(request_iterator,
            target,
            options=(),
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/DataProcessor/ProcessDataBatch',
            data__pb2.DataPoint.SerializeToString,
